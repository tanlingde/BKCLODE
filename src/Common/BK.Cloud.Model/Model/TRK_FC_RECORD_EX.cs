...
namespace BK.Cloud.Model.Data.Model
{
    ...
    [MetadataType(typeof(TRK_FC_RECORDMetadata))]
    public partial class TRK_FC_RECORD
    {
    }
    public class TRK_FC_RECORDMetadata
    {
        /// <summary>
        /// 卡号/坯料号
        ...
        /// </summary>
        [StringLength(255)]
        public object FC_RESULT { get; set; }
