...
{
    //如果要启用实体验证，请使用以下特性，并在 TRK_LW_SUMMARYMetadata 中定义验证特性。
    [MetadataType(typeof(TRK_LW_SUMMARYMetadata))]
    public partial class TRK_LW_SUMMARY
    {
    }
    public class TRK_LW_SUMMARYMetadata
    {
        /// <summary>
        ...
        /// <summary>
        /// 属性 BLANK_LONG_STOCK 的验证特性。
        /// </summary>
        [Required]
        public object BLANK_LONG_STOCK { get; set; }
        /// <summary>
        /// 属性 REMARKS 的验证特性。
        /// </summary>
        [StringLength(255)]
