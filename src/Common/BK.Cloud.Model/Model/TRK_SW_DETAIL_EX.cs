...
{
    //如果要启用实体验证，请使用以下特性，并在 TRK_SW_DETAILMetadata 中定义验证特性。
    [MetadataType(typeof(TRK_SW_DETAILMetadata))]
    public partial class TRK_SW_DETAIL
    {
    }
    public class TRK_SW_DETAILMetadata
    {
        /// <summary>
        /// 卡号/坯料号
