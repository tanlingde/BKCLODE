...
namespace BK.Cloud.Model.Data.Model
{
    ...
    /// </summary>
    [Serializable]
    [EntityMapping("TRK_SW_SUMMARY", Description = "短坯库库存主表")]
    public partial class TRK_SW_SUMMARY : LighEntityObject<TRK_SW_SUMMARY>
    {
        /// <summary>
        /// 获取或设置卡号/坯料号
        /// </summary>
        ...
        /// 获取或设置短坯库库存数量
        /// </summary>
        [PropertyMapping(ColumnName = "BLANK_SHORT_STOCK", Description = "短坯库库存数量")]
        public virtual int BLANK_SHORT_STOCK { get; set; }
        /// <summary>
        /// 获取或设置备注
        /// </summary>
